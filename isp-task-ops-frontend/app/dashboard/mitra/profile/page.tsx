...
export default function MitraProfilePage() {
  ...
  return (
    <div className="space-y-6">
      <div>
        <p className="text-sm font-semibold uppercase tracking-[0.18em] text-sky-700/70">Profil Mitra</p>
        <h1 className="text-3xl font-bold text-slate-950">Informasi akun reseller</h1>
        <p className="mt-2 text-sm text-slate-600">Detail akun yang sedang dipakai untuk mengelola pelanggan dan tiket.</p>
      </div>
